...
/*============================================================================*/
/*============================================================================*/
void O2EM_HOT_FUNC(handle_evbl)()
{
#ifdef __O2EM_PICO__
	int i;
	last_line = 0;
...
/*============================================================================*/
/*============================================================================*/
void O2EM_HOT_FUNC(write_p1)(Byte d)
{
	if ((d & 0x80) != (p1 & 0x80)) {
		int i,l;
...
Byte O2EM_HOT_FUNC(ext_read)(ADDRESS adr) {
	Byte d;
	Byte si;
	Byte m;
	int i;
...
/*============================================================================*/
/*============================================================================*/
void O2EM_HOT_FUNC(ext_write)(Byte dat, ADDRESS adr) {
	int i;
	int l;
...
int O2EM_HOT_FUNC(snapline)(int pos, Byte reg, int t) {
	int i;
